...
def mock_checkpoint():
  ...
  span = Span(trace_id="t1", span_id="s1", name="test_span", start_time_ns=0, instrumentation_name="test", instrumentation_version="1")
...
def test_start_debugging_session_calls_pdb_and_context(mock_context, mock_pdb, mock_checkpoint):
